  ...
  return (
    <div className='w-2/6 bg-white shadow-md m-auto p-6 rounded-md'>
      ...
      <div className='mb-4'>
        ...
        <input type="text" placeholder='you@mail.com' className='border py-2 px-4 w-full rounded-md'/>
      </div>
      <div className='mb-8'>
        <h3 className='mb-1'>Password</h3>
        <input type="password" placeholder='Password' className='border py-2 px-4 w-full rounded-md'/>
      </div>
